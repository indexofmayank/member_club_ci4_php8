...
<div class="card">
   <div class="card-body">
      <div class="row">
         ...
         <div class="mb-3 col-6 d-flex justify-content-end align-items-center">
            <ul class="list-group">
               <li class="list-group-item">Total Members: <?= esc($totalMember) ?></li>
               <li class="list-group-item">Active Members: <?=esc($activeCount) ?></li>
            </ul>
         </div>
      </div>
...
<script>
   document.addEventListener('DOMContentLoaded', function () {
       ...
       document.getElementById('confirmDelete').addEventListener('click', function() {
           window.location.href = '<?= base_url('member-delete') ?>/' + memberId;
       });
   });
</script>
<?= $this->endSection() ?>